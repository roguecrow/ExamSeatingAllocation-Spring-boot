...
public class GetAllExamsRowMapper implements RowMapper<Exam> {
    @Override
    public Exam mapRow(ResultSet resultSet, int rowNum) throws SQLException {
        ...
        return new Exam(examId, examName, description, examDate, applicationStartDate, applicationEndDate);
    }
}
